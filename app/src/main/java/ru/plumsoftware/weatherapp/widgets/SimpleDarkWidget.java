 ...
 */
public class SimpleDarkWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.simple_dark_widget);
        views.setTextViewText(R.id.textViewMainLocationD, city);
        views.setImageViewResource(R.id.imageView2D, R.drawable.ic_widget_location);
        views.setImageViewResource(R.id.imageView, R.drawable.ic_refresh);
        ...
        weatherManager.getCurrentWeather(city, "8babcdab0f80b414d35b6d4b0f3e752e", units, lang).enqueue(new Callback<CurrentWeather>() {
            ...
            public void onResponse(@NonNull Call<CurrentWeather> call, @NonNull Response<CurrentWeather> response) {
                if (response.isSuccessful()) {
                    ...
                    RemoteViews updateViews = new RemoteViews(context.getPackageName(), R.layout.simple_dark_widget);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            final ComponentName cn = new ComponentName(context, SimpleDarkWidget.class);
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (FORCE_WIDGET_UPDATE.equals(intent.getAction())) {
            ...
            ComponentName watchWidget = new ComponentName(context, SimpleDarkWidget.class);
    ...
    protected static PendingIntent getPendingSelfIntent(Context context, String action) {
        Intent intent = new Intent(context, SimpleDarkWidget.class);
